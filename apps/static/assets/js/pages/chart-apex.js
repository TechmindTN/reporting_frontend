    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#d20400", "#0e9e4a", "#FFB64D", "#FF5370"],
                responsive: [{
                    breakpoint: 480,
                    options: {
                        legend: {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#d20400", "#00bcd4", "#0e9e4a", "#FFB64D", "#FF5370"],
                stroke: {
                    width: 1,
                    colors: ['#fff']
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ["#d20400", "#0e9e4a", "#FF5370", "#FFB64D", "#00bcd4"],
                series: [{
                    name: "SAMPLE A",
                    data: [
                        [16.4, 5.4],
        ...
        $(function() {
            var options = {
                ...
                colors: ["#d20400", "#0e9e4a", "#00bcd4", "#FFB64D", "#FF5370"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
